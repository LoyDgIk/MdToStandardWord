...
S_APPENDIX_TABLE_LABEL = "标准文件_附录表标号"      # 附录表题编号的 A/B/C 锚点
S_APPENDIX_FIGURE_LABEL = "标准文件_附录图标号"     # 附录图题编号的 A/B/C 锚点
S_TABLE_CELL = "标准文件_表格"             # 表格单元格内文字
S_FIG_TABLE_NOTE = "标准文件_图表脚注"      # 模板自带图表脚注编号段落；普通注不使用
